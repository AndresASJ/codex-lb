...
## [1.25.0](https://github.com/Soju06/codex-lb/compare/v1.24.0...v1.25.0) (2026-09-21)


### ⚠ BREAKING CHANGES

* **auth:** dashboard 403 denials on permission-gated routes now return code permission_required with param=<permission>. Admin-only reads (conversations, conversation archive, audit log) no longer return admin_access_required, and the re-gated mutations (account credential exports, firewall rules, guest password, upstream-proxy endpoint creation) return permission_required instead of read_only_access to a guest. The read/write session permissions and built-in admin/guest behavior are otherwise unchanged.
* **config:** the env vars above are no longer read. extra="ignore" keeps startup working and each name emits the one-release removed-settings warning; operators relying on the retention env aliases must set the window once in Settings -> Advanced -> Data retention.
* **settings:** CODEX_LB_UPSTREAM_STREAM_TRANSPORT is removed (startup WARN if still set). Operators who pinned it to http/websocket must pin the transport in Settings -> Routing -> Upstream stream transport after upgrade.

### Features

* **audit:** record the acting account, target and severity on audit rows ([#2225](https://github.com/Soju06/codex-lb/issues/2225)) ([8e57607](https://github.com/Soju06/codex-lb/commit/8e5760726a34332d869aac682a3932170621966b))
* **auth:** add an OIDC identity provider with UI-configured, encrypted connection settings ([#2411](https://github.com/Soju06/codex-lb/issues/2411)) ([837964b](https://github.com/Soju06/codex-lb/commit/837964b914c73058ba0e3bb0a10fd6c6403f9a18))
* **auth:** add dashboard role rows with code-defined preset grants ([#2217](https://github.com/Soju06/codex-lb/issues/2217)) ([08f9634](https://github.com/Soju06/codex-lb/commit/08f9634e9fb2f1fbc48932c3c522a59b88588e76))
* **auth:** add dashboard user tables and migrate the shared admin into a user ([#2218](https://github.com/Soju06/codex-lb/issues/2218)) ([195b33b](https://github.com/Soju06/codex-lb/commit/195b33b8cc9fdb10b91eb2f045daa1e58fbdc6ff))
* **auth:** add resource-scoped dashboard permission vocabulary ([#2196](https://github.com/Soju06/codex-lb/issues/2196)) ([9559603](https://github.com/Soju06/codex-lb/commit/95596039434e855f36520fbc9477552b7aa960f9))
* **auth:** connect company sign-in from Organisation settings ([#2417](https://github.com/Soju06/codex-lb/issues/2417)) ([ca243de](https://github.com/Soju06/codex-lb/commit/ca243dec437d82c407ff2da8f64b61e0a0189e43))
* **auth:** enable the operator and viewer presets end to end, require TOTP for admin-level accounts ([#2328](https://github.com/Soju06/codex-lb/issues/2328)) ([aa75e1c](https://github.com/Soju06/codex-lb/commit/aa75e1c12aa802b6364c68aafd3da194b3c3cf01))
* **auth:** gate local password sign-in behind a policy and protect break-glass access ([#2385](https://github.com/Soju06/codex-lb/issues/2385)) ([1330855](https://github.com/Soju06/codex-lb/commit/1330855ec6988ab3eb72c0ee3c3d41cbce02324c))
* **auth:** make dashboard users the source of truth for login and sessions ([#2223](https://github.com/Soju06/codex-lb/issues/2223)) ([9cfce7f](https://github.com/Soju06/codex-lb/commit/9cfce7f21bbad6595acf688be2864f3e466ee5c0))
* **auth:** map identity-provider groups to roles and add the organisation settings group ([#2358](https://github.com/Soju06/codex-lb/issues/2358)) ([4096c18](https://github.com/Soju06/codex-lb/commit/4096c18acffcfca9267258057678e3898744db85))
* **auth:** provision and deprovision accounts over SCIM 2.0 ([#2431](https://github.com/Soju06/codex-lb/issues/2431)) ([1d4ad21](https://github.com/Soju06/codex-lb/commit/1d4ad21f716d5b4b959a826dd7ade6abec08f198))
* **auth:** re-verify a credential before sensitive dashboard changes ([#2334](https://github.com/Soju06/codex-lb/issues/2334)) ([c9d5443](https://github.com/Soju06/codex-lb/commit/c9d5443ca07874fb3de5bd3ee88f355d033464a1))
* **auth:** reject cross-site dashboard mutations and start the client least-privilege ([#2204](https://github.com/Soju06/codex-lb/issues/2204)) ([e040053](https://github.com/Soju06/codex-lb/commit/e040053b0b9ec07dd46805660c18e6ffa1bc6876))
* **auth:** resolve trusted-header identities to accounts through sign-in providers ([#2331](https://github.com/Soju06/codex-lb/issues/2331)) ([94fb4d0](https://github.com/Soju06/codex-lb/commit/94fb4d0a33b7681bc1276b9b013150bd2bd33974))
* **auth:** restrict guest-visible sensitive surfaces and make guest sessions revocable ([#2201](https://github.com/Soju06/codex-lb/issues/2201)) ([d6a7ca6](https://github.com/Soju06/codex-lb/commit/d6a7ca662860e2b427e462f434319273bcd240bd))
* **dashboard:** add a cross-account prompt cache isolation probe ([#2372](https://github.com/Soju06/codex-lb/issues/2372)) ([8256755](https://github.com/Soju06/codex-lb/commit/82567556f9f75ea13986667fc5282f035b7ca8d2))
* **dashboard:** hide restricted surfaces from read-only guests ([#2203](https://github.com/Soju06/codex-lb/issues/2203)) ([478e960](https://github.com/Soju06/codex-lb/commit/478e96035c044f1dd2cff1d2398f16daa49190c1))
...
* **dashboard:** surface subscription-overflow attribution in the request log and dashboard ([#2123](https://github.com/Soju06/codex-lb/issues/2123) WP-G) ([#2355](https://github.com/Soju06/codex-lb/issues/2355)) ([21eedbf](https://github.com/Soju06/codex-lb/commit/21eedbfda6c36ef8e9cdda94a7c73b6c0d98b540))
* **dashboard:** surface thread identity and cache locality metrics ([#2378](https://github.com/Soju06/codex-lb/issues/2378)) ([b36e5a0](https://github.com/Soju06/codex-lb/commit/b36e5a050d28074f47c777f639f03fcf2fc74472))
...
* **db:** add subscription-overflow schema (model_source_pins, dashboard_settings columns) ([#2165](https://github.com/Soju06/codex-lb/issues/2165)) ([c1da68b](https://github.com/Soju06/codex-lb/commit/c1da68b167dab64a4160019066d86fbc1349ca56))
* **frontend:** fold the auth cards into one Access card that grows with the team ([#2251](https://github.com/Soju06/codex-lb/issues/2251)) ([53253c1](https://github.com/Soju06/codex-lb/commit/53253c11621c26646f2c95acae2b958fcb5f0432))
* **frontend:** show provenance and reset-to-inherited on data retention settings ([#2231](https://github.com/Soju06/codex-lb/issues/2231)) ([8aecad8](https://github.com/Soju06/codex-lb/commit/8aecad868aa21ea72b727ecc7c995f08e0a85d61))
* **frontend:** tier the login form and header by account facts, add the invite route ([#2237](https://github.com/Soju06/codex-lb/issues/2237)) ([04a309d](https://github.com/Soju06/codex-lb/commit/04a309df223674d1d90cbe622481c9ab40aceee5))
* **load-balancer:** discount relatively slow accounts (first-token latency + per-model output throughput) in weighted selection ([#2258](https://github.com/Soju06/codex-lb/issues/2258)) ([dda902d](https://github.com/Soju06/codex-lb/commit/dda902de6c7ec9848dd0056532357b08628c50a5))
* **metadata:** automate pricing and Codex version updates with cost backfill ([#2298](https://github.com/Soju06/codex-lb/issues/2298)) ([2554fdd](https://github.com/Soju06/codex-lb/commit/2554fdd7a8e2a169587d335dbf807dfa307c7591))
...
* **proxy:** add shared/isolated thread cache identity modes (default shared) ([#2376](https://github.com/Soju06/codex-lb/issues/2376)) ([883c914](https://github.com/Soju06/codex-lb/commit/883c9140b0836ffc3e9eb601665f24c191e71bb0))
* **proxy:** allow plaintext proxy credentials and surface a dashboard warning ([#2144](https://github.com/Soju06/codex-lb/issues/2144)) ([a8339c8](https://github.com/Soju06/codex-lb/commit/a8339c8f57442b0cb2dd8a15737d6e7fb0cbdb38))
...
* **proxy:** persist hashed affinity decisions on request logs ([#2352](https://github.com/Soju06/codex-lb/issues/2352)) ([e32f85c](https://github.com/Soju06/codex-lb/commit/e32f85c98664bef9cc7928367b34eef087bfa9a4))
* **proxy:** subscription-exhaustion overflow to a designated model source (ship-dark) ([#2257](https://github.com/Soju06/codex-lb/issues/2257)) ([66a3e70](https://github.com/Soju06/codex-lb/commit/66a3e703465c8e9d55e83e65e8121c7768169a80))
* **proxy:** subscription-overflow core modules and hardened direct model-source routing ([#2208](https://github.com/Soju06/codex-lb/issues/2208)) ([5e6f3de](https://github.com/Soju06/codex-lb/commit/5e6f3de0461c81f0ede15d4acee7e6d41e210da9))
* **proxy:** trace terminal-frame delivery on Responses SSE streams ([#2244](https://github.com/Soju06/codex-lb/issues/2244)) ([95a9cab](https://github.com/Soju06/codex-lb/commit/95a9cab07f83809b8e955261b57e34aede8150e6))
* **settings:** conversation archive toggle in the dashboard ([#2275](https://github.com/Soju06/codex-lb/issues/2275)) ([39e5f44](https://github.com/Soju06/codex-lb/commit/39e5f44c39898c539d728a60fd9021226e63e4b1))
* **settings:** expose setting provenance and unify inheritable resolver ([#2214](https://github.com/Soju06/codex-lb/issues/2214)) ([ad4a08c](https://github.com/Soju06/codex-lb/commit/ad4a08c4873f6d272a3c8a110cdacad4c9ce35c3))
* **settings:** manage Codex session prewarm from the dashboard ([#2264](https://github.com/Soju06/codex-lb/issues/2264)) ([1205237](https://github.com/Soju06/codex-lb/commit/1205237328b5c15a4d5bf8e7f5e4d5503a1e8734))
* **settings:** manage resilience toggles from the dashboard ([#2220](https://github.com/Soju06/codex-lb/issues/2220)) ([c38e4de](https://github.com/Soju06/codex-lb/commit/c38e4de15beead64910cf074e9e457781aeb5ff7))
* **settings:** manage routing weights and overload isolation from the dashboard ([#2224](https://github.com/Soju06/codex-lb/issues/2224)) ([09b48eb](https://github.com/Soju06/codex-lb/commit/09b48eb2768e4f4a6a19ab3fabd7a0280669ad01))
* **settings:** manage stream and bridge request budgets from the dashboard ([#2279](https://github.com/Soju06/codex-lb/issues/2279)) ([efe0f58](https://github.com/Soju06/codex-lb/commit/efe0f581a18a36f4d491b92a36ef79b0c432d252))
* **settings:** manage the bridge operation spool retention from the dashboard ([#2337](https://github.com/Soju06/codex-lb/issues/2337)) ([6d11e56](https://github.com/Soju06/codex-lb/commit/6d11e560c9324a5f2ad7a0c6260780f1d2df2ea9))
* **settings:** manage upstream timeouts and request budgets from the dashboard ([#2221](https://github.com/Soju06/codex-lb/issues/2221)) ([5794d8d](https://github.com/Soju06/codex-lb/commit/5794d8d7a70e113afae4df0d83b03058831f0bbd))
* **settings:** pause background schedulers from the dashboard ([#2281](https://github.com/Soju06/codex-lb/issues/2281)) ([069b82b](https://github.com/Soju06/codex-lb/commit/069b82be3ceda8e468094f03aee0884061b2b43e))
* **settings:** per-model context window overrides in the dashboard ([#2265](https://github.com/Soju06/codex-lb/issues/2265)) ([f1ff7c7](https://github.com/Soju06/codex-lb/commit/f1ff7c7c3309a478a998bd1c66159affd7aed961))
* **settings:** subscription-overflow model source setting, preflight and drain deadline (inert) ([#2176](https://github.com/Soju06/codex-lb/issues/2176)) ([788baae](https://github.com/Soju06/codex-lb/commit/788baaed28988cdc355bbb4175f3da418e0cb6b0))
...
* **usage:** coalesced on-demand account refresh after usage_limit_reached ([#2125](https://github.com/Soju06/codex-lb/issues/2125)) ([35ccf8e](https://github.com/Soju06/codex-lb/commit/35ccf8e9369b10e5819229ac674a3e1c5f6569ae))
* **users:** add account management, invite links and the roles read API ([#2226](https://github.com/Soju06/codex-lb/issues/2226)) ([561311d](https://github.com/Soju06/codex-lb/commit/561311ded1d3191cf1ef271d4cd8ea97f8fd17a4))


### Bug Fixes

* **accounts:** let the deletion scheduler exit its wait promptly ([#2362](https://github.com/Soju06/codex-lb/issues/2362)) ([c62bdd8](https://github.com/Soju06/codex-lb/commit/c62bdd80fca9f7a15c142947b3ddfe1c2cc01319))
...
* **accounts:** recover a rate-limited account on any confirmed window reset ([#2405](https://github.com/Soju06/codex-lb/issues/2405)) ([3d501ac](https://github.com/Soju06/codex-lb/commit/3d501ac5eae2ec3201d3d0a98b961793db519a27)), closes [#2404](https://github.com/Soju06/codex-lb/issues/2404) [#676](https://github.com/Soju06/codex-lb/issues/676)
...
* **api-keys:** prevent caching returned secrets ([#2021](https://github.com/Soju06/codex-lb/issues/2021)) ([a07ce56](https://github.com/Soju06/codex-lb/commit/a07ce563b2fdcb8c243eccc17d1001f3a27d42a1))
...
* **audit:** restrict log access to admins ([#2022](https://github.com/Soju06/codex-lb/issues/2022)) ([0ca5c72](https://github.com/Soju06/codex-lb/commit/0ca5c7249e7e899876a4a5f2ba2c104f6adc9565))
...
* **automations:** pin the stale-claim reclaim window to the budget captured at run start ([#2241](https://github.com/Soju06/codex-lb/issues/2241)) ([0da41b6](https://github.com/Soju06/codex-lb/commit/0da41b64e802331faae01077c89e8c8580b4bce0))
* **balancer:** count bare server_error terminals toward overload backoff ([#2360](https://github.com/Soju06/codex-lb/issues/2360)) ([7f79297](https://github.com/Soju06/codex-lb/commit/7f792970d72b0c6f88bbfd48f1f5e86278997ba7))
* **balancer:** isolate sustained-overload accounts and weight selection by error rate ([#2166](https://github.com/Soju06/codex-lb/issues/2166)) ([3de4be2](https://github.com/Soju06/codex-lb/commit/3de4be2aa9221db6a7137daca4c14c5d2a1ff639))
* **balancer:** retain warm soft sticky owners through overload isolation ([#2408](https://github.com/Soju06/codex-lb/issues/2408)) ([e54d974](https://github.com/Soju06/codex-lb/commit/e54d97433eb0d71501cf7d46b81c6e13aed9f9b4))
* **balancer:** stop waiting on a hard affinity owner the caller excluded ([#2381](https://github.com/Soju06/codex-lb/issues/2381)) ([2c85399](https://github.com/Soju06/codex-lb/commit/2c8539921ca6d1eef572c45ec3e3f51e6c3ec095)), closes [#2163](https://github.com/Soju06/codex-lb/issues/2163)
* **build:** make local CI work in Nix shell ([#2148](https://github.com/Soju06/codex-lb/issues/2148)) ([c4e58b0](https://github.com/Soju06/codex-lb/commit/c4e58b02d354164754e49e575823eb7c0ab31bb7))
* **ci:** unbreak main — rustls advisory, missing contributor, stale bun.nix ([#2453](https://github.com/Soju06/codex-lb/issues/2453)) ([986a9bf](https://github.com/Soju06/codex-lb/commit/986a9bf1d3fd490a23e57b21e3dfc418205b0888))
* **clients:** reuse system trust for Python WSS ([#2110](https://github.com/Soju06/codex-lb/issues/2110)) ([bb98cdf](https://github.com/Soju06/codex-lb/commit/bb98cdf4bd15d5c573b551cdfcc8f73efb75bf39))
* **compact:** fail over revoked refresh accounts ([#2080](https://github.com/Soju06/codex-lb/issues/2080)) ([b2c5ffc](https://github.com/Soju06/codex-lb/commit/b2c5ffccee84f1ebf8e6099515f5b9caf3922efd))
...
* **dashboard:** recover failed routes ([#2018](https://github.com/Soju06/codex-lb/issues/2018)) ([628b620](https://github.com/Soju06/codex-lb/commit/628b62061c54e5ac53ee15f10f21519113491d23))
* **dashboard:** recover from overview load errors ([#2017](https://github.com/Soju06/codex-lb/issues/2017)) ([80265ff](https://github.com/Soju06/codex-lb/commit/80265ff8552d4aaface0497d4035561b3200fb01))
* **db:** avoid reclaiming completed SQLite teardown ([#2030](https://github.com/Soju06/codex-lb/issues/2030)) ([ed2b36d](https://github.com/Soju06/codex-lb/commit/ed2b36dfb19f6b202630a5805427b87a28a17a69)), closes [#2105](https://github.com/Soju06/codex-lb/issues/2105)
...
* **db:** converge the forked thread-cache and bridge-retirement heads ([#2400](https://github.com/Soju06/codex-lb/issues/2400)) ([d28b3ad](https://github.com/Soju06/codex-lb/commit/d28b3ad26a02624b28758412719f561b63811e25))
* **db:** merge overflow and transport migration heads ([#2198](https://github.com/Soju06/codex-lb/issues/2198)) ([05a669e](https://github.com/Soju06/codex-lb/commit/05a669e68c8f5a81fb95c3082a90e32568e09ba8))
* **db:** merge the pin-index and affinity alembic heads ([#2368](https://github.com/Soju06/codex-lb/issues/2368)) ([53f9687](https://github.com/Soju06/codex-lb/commit/53f9687230247c1870c43389d2a88170e362d716))
* **db:** preserve rollback after SQLite invalidation ([#2193](https://github.com/Soju06/codex-lb/issues/2193)) ([d2b2e77](https://github.com/Soju06/codex-lb/commit/d2b2e7784b0d29a3051de002eab8fac0853f3248))
* **db:** retry the startup sentinel seed on SQLite lock contention and name the lock error ([#2339](https://github.com/Soju06/codex-lb/issues/2339)) ([1f34281](https://github.com/Soju06/codex-lb/commit/1f34281d1b21107ebf6494cfb41cad5dd5d35131))
...
* **deps:** require anyio&gt;=4.14 to close Lock cancelled-waiter deadlock ([#2129](https://github.com/Soju06/codex-lb/issues/2129)) ([c085177](https://github.com/Soju06/codex-lb/commit/c085177110b4b80d5aba7cdef50093efd5565b4f))
* **docker:** update installed Debian runtime packages ([#2407](https://github.com/Soju06/codex-lb/issues/2407)) ([2a24140](https://github.com/Soju06/codex-lb/commit/2a2414015d607a513f7c8b49afe6111bdf88f097))
* **egress:** bound the native stream queue by a byte budget instead of 64 events ([#2173](https://github.com/Soju06/codex-lb/issues/2173)) ([0ebf03f](https://github.com/Soju06/codex-lb/commit/0ebf03f3e664979e82b6246ef161e1e00ecb9425))
...
* **http-bridge:** abandon expired ambiguous operations ([#2071](https://github.com/Soju06/codex-lb/issues/2071)) ([dd28d7d](https://github.com/Soju06/codex-lb/commit/dd28d7dff94cdd4919067c1986fd9606b9bbc6b9))
* **http-bridge:** bound terminal spool writes ([#1997](https://github.com/Soju06/codex-lb/issues/1997)) ([3d90273](https://github.com/Soju06/codex-lb/commit/3d90273e993169f91a4b2ec9dec4ab337cc4af0a))
* **http-bridge:** keep accepted output-free replays on a hard sticky owner instead of excluding it ([#2150](https://github.com/Soju06/codex-lb/issues/2150)) ([ae330ba](https://github.com/Soju06/codex-lb/commit/ae330ba9edd71a93a11151b01446a025e9d5db59))
...
* **http-bridge:** reject unsafe forwarded headers ([#2087](https://github.com/Soju06/codex-lb/issues/2087)) ([63ac6ae](https://github.com/Soju06/codex-lb/commit/63ac6aee0438d86c89654d326d2e904b96f1b463))
...
* **http-bridge:** reuse reservation during local recovery ([#2353](https://github.com/Soju06/codex-lb/issues/2353)) ([98d2256](https://github.com/Soju06/codex-lb/commit/98d2256d843c3946b0b9e6e0d2140fded05692c6))
* **http-bridge:** treat usage_limit_reached as a terminal in the account capacity wait ([#2124](https://github.com/Soju06/codex-lb/issues/2124)) ([80ea67f](https://github.com/Soju06/codex-lb/commit/80ea67f9adc3f00623ee719a479837dc9c871087))
...
* **images:** select compatible host for images and probes ([#2320](https://github.com/Soju06/codex-lb/issues/2320)) ([92c7f62](https://github.com/Soju06/codex-lb/commit/92c7f6201a8fd31d6160570f60ee59db5686dd67))
* **load-balancer:** keep soft sticky owner when it is only request-locally unavailable ([#2234](https://github.com/Soju06/codex-lb/issues/2234)) ([81b9fbd](https://github.com/Soju06/codex-lb/commit/81b9fbd58d1e5981fdee0b6fec466729b998210a))
* **logging:** bound secret patterns to the current line ([#2091](https://github.com/Soju06/codex-lb/issues/2091)) ([8d02c82](https://github.com/Soju06/codex-lb/commit/8d02c8246bd30041af79eb32b84a9909b740794e))
* **logging:** redact secrets in asyncio loop exception-handler context and harden proxy username validation ([6ecbd8b](https://github.com/Soju06/codex-lb/commit/6ecbd8bd074486c36b5b9199352b75e9e561121c))
...
* **metrics:** bound request metric path and method label cardinality ([#1967](https://github.com/Soju06/codex-lb/issues/1967)) ([fed5473](https://github.com/Soju06/codex-lb/commit/fed54730baed25bd6cbc6d0d800713859a9927e9))
...
* **model-registry:** warm the Codex client version cache on every replica and track the current release ([#2174](https://github.com/Soju06/codex-lb/issues/2174)) ([90e9870](https://github.com/Soju06/codex-lb/commit/90e987030e14f821ab7eb2dcc9e9891a2cccb5cd))
* **model-sources:** own the chat-completions source transport through the streamed response and tidy WP-C1 residuals ([#2222](https://github.com/Soju06/codex-lb/issues/2222)) ([2a09317](https://github.com/Soju06/codex-lb/commit/2a093177a46e7abf9beb0998c4e302fd3efae242))
* **native:** prevent false backpressure on buffered response bursts ([#2143](https://github.com/Soju06/codex-lb/issues/2143)) ([9703ef9](https://github.com/Soju06/codex-lb/commit/9703ef9b17f677cd3ba2d8dcb0ccead879c259e5))
* **oauth:** expire abandoned browser callback listeners ([#2079](https://github.com/Soju06/codex-lb/issues/2079)) ([5650037](https://github.com/Soju06/codex-lb/commit/56500375e58ca053638498ba6d438b274fc14661))
...
* **observability:** derive sticky_key_source once, from the resolved policy ([#2375](https://github.com/Soju06/codex-lb/issues/2375)) ([cc25f27](https://github.com/Soju06/codex-lb/commit/cc25f2784cf0f2ffba71bcc032206c33cdf03641))
* **openspec:** repair and enforce canonical validation ([#2025](https://github.com/Soju06/codex-lb/issues/2025)) ([1c54f9a](https://github.com/Soju06/codex-lb/commit/1c54f9ae1683892fb80ac801f198af27859b3676))
* **overflow:** keep a delivered source turn anchored before the first content frame ([#2354](https://github.com/Soju06/codex-lb/issues/2354)) ([9368d49](https://github.com/Soju06/codex-lb/commit/9368d4912db206b86564b2afe9b2608f9aba45f3))
* **proxy:** anchor unanchored HTTP threads to a stable cache key ([#2367](https://github.com/Soju06/codex-lb/issues/2367)) ([ef70105](https://github.com/Soju06/codex-lb/commit/ef701057c22212f11ae29c0765e9b40d9701bbc8))
* **proxy:** attribute refused cross-account continuity replays ([#2384](https://github.com/Soju06/codex-lb/issues/2384)) ([63314a1](https://github.com/Soju06/codex-lb/commit/63314a1b2c0894805422c2bc3c23b6e44fb35417))
* **proxy:** back off code-less upstream 429 bursts instead of passing them through ([#2240](https://github.com/Soju06/codex-lb/issues/2240)) ([2a43034](https://github.com/Soju06/codex-lb/commit/2a4303492f2c1fd209a7490cf1493c98b56ffde1)), closes [#2239](https://github.com/Soju06/codex-lb/issues/2239)
* **proxy:** bound aggregate detached retirement lock waits ([#2315](https://github.com/Soju06/codex-lb/issues/2315)) ([09b8e89](https://github.com/Soju06/codex-lb/commit/09b8e8916b0cbee17109e43e447712481bce9959))
* **proxy:** bound the detached-session retire sweep's pending_lock wait ([#2139](https://github.com/Soju06/codex-lb/issues/2139)) ([58c6a28](https://github.com/Soju06/codex-lb/commit/58c6a28f24b8672830ca4bdda911fe6f191de47e))
...
* **proxy:** deliver the denied-anchor refusal to native clients ([#2387](https://github.com/Soju06/codex-lb/issues/2387)) ([b04b278](https://github.com/Soju06/codex-lb/commit/b04b27816b5639e3fbb5859f58c9df0acb72545f))
...
* **proxy:** filter vendor events from public Responses streams ([#2114](https://github.com/Soju06/codex-lb/issues/2114)) ([ec34582](https://github.com/Soju06/codex-lb/commit/ec3458219b7f2c2765fd418bb68d58e241ce38ca))
* **proxy:** fork model-transition owner conflicts ([#2083](https://github.com/Soju06/codex-lb/issues/2083)) ([9db05a1](https://github.com/Soju06/codex-lb/commit/9db05a1b13b7301dd9c4f31b40e4d7b28709839e))
* **proxy:** forward canonical prompt-cache continuations ([#2036](https://github.com/Soju06/codex-lb/issues/2036)) ([aec4d7b](https://github.com/Soju06/codex-lb/commit/aec4d7b7f66128ece52c09398c546fddea260d94)), closes [#2035](https://github.com/Soju06/codex-lb/issues/2035)
* **proxy:** ignore detached durable bridge rows as continuity owner evidence ([#2063](https://github.com/Soju06/codex-lb/issues/2063)) ([7e1c1e8](https://github.com/Soju06/codex-lb/commit/7e1c1e82614aa6223737ff45461a5494c1f29256))
* **proxy:** keep proxy credentials out of aiohttp ConnectionKey and redact URL userinfo in rendered logs ([9c188de](https://github.com/Soju06/codex-lb/commit/9c188de2c1e9bfc3e21f810d890c1bb17fc8ce8c))
* **proxy:** keep safety policy blocks account-neutral ([#2131](https://github.com/Soju06/codex-lb/issues/2131)) ([b28d9af](https://github.com/Soju06/codex-lb/commit/b28d9afc9473baf0fab070728259c859fc49097e))
...
* **proxy:** keep tool_search_output in public responses ([#2092](https://github.com/Soju06/codex-lb/issues/2092)) ([0e14c24](https://github.com/Soju06/codex-lb/commit/0e14c24f631fb1f82c6a0d082156f17d3e956453)), closes [#1952](https://github.com/Soju06/codex-lb/issues/1952)
...
* **proxy:** narrow the input-image upstream transport pin ([#2386](https://github.com/Soju06/codex-lb/issues/2386)) ([cb21daa](https://github.com/Soju06/codex-lb/commit/cb21daaed6a786b8d15467ad45d44e71d1ed48e9))
* **proxy:** normalize native HTTP compression ([#2012](https://github.com/Soju06/codex-lb/issues/2012)) ([dee12b9](https://github.com/Soju06/codex-lb/commit/dee12b9530b0b4f6777bd81d7e824315e0a4bea2))
* **proxy:** normalize SDK transcription headers ([#2031](https://github.com/Soju06/codex-lb/issues/2031)) ([e9100e5](https://github.com/Soju06/codex-lb/commit/e9100e5a8f83970df7bcd9feb739e1b820c6b27a))
...
* **proxy:** prevent exhausted accounts from reactivating ([#2078](https://github.com/Soju06/codex-lb/issues/2078)) ([3d34092](https://github.com/Soju06/codex-lb/commit/3d34092d94dcb2f6b66099459b2216b6b7368a28))
* **proxy:** prevent level-cancellation busy spins ([#1958](https://github.com/Soju06/codex-lb/issues/1958)) ([887cba3](https://github.com/Soju06/codex-lb/commit/887cba30b37f271f35cb3bbb600bf6f694498a4b))
* **proxy:** promote agentic HTTP continuations to reusable WebSockets ([#2247](https://github.com/Soju06/codex-lb/issues/2247)) ([ffaf687](https://github.com/Soju06/codex-lb/commit/ffaf6878db1e549a20c4472ed1fa80b7fbb17e16))
* **proxy:** publish HTTP response owners before delivery ([#2111](https://github.com/Soju06/codex-lb/issues/2111)) ([d1fd2f2](https://github.com/Soju06/codex-lb/commit/d1fd2f21fa0e0f3b5fcad3af5fada19693cd1fc1))
...
* **proxy:** read the usage-limit rejection off the frame upstream actually sends ([#2449](https://github.com/Soju06/codex-lb/issues/2449)) ([143e07d](https://github.com/Soju06/codex-lb/commit/143e07d06bdf49019f5d1af42559f48049487d1f))
...
* **proxy:** report duplicate tool-call replay terminal ([#2082](https://github.com/Soju06/codex-lb/issues/2082)) ([be9fa06](https://github.com/Soju06/codex-lb/commit/be9fa06f544cdd8697b630a906ed6f4df6b568db))
* **proxy:** restore trusted Codex routing hints ([#2242](https://github.com/Soju06/codex-lb/issues/2242)) ([0083bc6](https://github.com/Soju06/codex-lb/commit/0083bc639d51bc95719ee25f4918569d66bb81cd))
* **proxy:** retire a continuity owner that cannot return in time ([#2397](https://github.com/Soju06/codex-lb/issues/2397)) ([2852cf6](https://github.com/Soju06/codex-lb/commit/2852cf60c8969967c0d328114c6d290a37032d5e))
* **proxy:** retire a denied proxy-injected WebSocket anchor instead of re-injecting it ([#2248](https://github.com/Soju06/codex-lb/issues/2248)) ([6b3d031](https://github.com/Soju06/codex-lb/commit/6b3d031e52f986c4d93b5e7fdae35eb036507f09))
* **proxy:** retire cooldown-suppressed HTTP bridge sessions ([#2072](https://github.com/Soju06/codex-lb/issues/2072)) ([018659d](https://github.com/Soju06/codex-lb/commit/018659d35bd362f9aa7b85592933b2e531ea29f4))
* **proxy:** retire durably unroutable bridge continuity owners ([#2390](https://github.com/Soju06/codex-lb/issues/2390)) ([10cd71a](https://github.com/Soju06/codex-lb/commit/10cd71ad0494f89a858fe2d811fdc3ed058db9ef))
* **proxy:** retry accepted output-free capacity failures with a single response lifecycle ([#2127](https://github.com/Soju06/codex-lb/issues/2127)) ([dafc1a2](https://github.com/Soju06/codex-lb/commit/dafc1a21de88cea0c94124e964a02a5d046cb8bb))
* **proxy:** route anonymous output frames to the created response ([#2357](https://github.com/Soju06/codex-lb/issues/2357)) ([976d20b](https://github.com/Soju06/codex-lb/commit/976d20b712a703dde4b45b8150cb9b0e37668f28))
* **proxy:** sanitize rebuilt HTTP hop-by-hop headers ([5be82ef](https://github.com/Soju06/codex-lb/commit/5be82ef40d5b63ae1c54c8e25e2e0cccb5caef39))
* **proxy:** settle accepted background JSON ([#2014](https://github.com/Soju06/codex-lb/issues/2014)) ([b328cc9](https://github.com/Soju06/codex-lb/commit/b328cc9734b8316d2877f9c117f9816ee8027e58))
...
* **proxy:** settle keyed streams before health ([#1989](https://github.com/Soju06/codex-lb/issues/1989)) ([da1dce6](https://github.com/Soju06/codex-lb/commit/da1dce6d65ffbf0450ac0d40f7c37d5c8cdc8ba6))
...
* **proxy:** stop level-cancel cascade from respinning deferred probe cleanup ([#2130](https://github.com/Soju06/codex-lb/issues/2130)) ([8dc74ba](https://github.com/Soju06/codex-lb/commit/8dc74baa0b8b79e703a39cc130e258fc4da35bd7))
...
* **routing:** deprioritize accounts upstream keeps rejecting as overloaded for fresh selection ([#2137](https://github.com/Soju06/codex-lb/issues/2137)) ([7b0f717](https://github.com/Soju06/codex-lb/commit/7b0f717501c20b1a7be5534246539d88a8e058e4))
* **routing:** resolve soft-drain from the dashboard snapshot on background paths ([#2233](https://github.com/Soju06/codex-lb/issues/2233)) ([6cdf29e](https://github.com/Soju06/codex-lb/commit/6cdf29efb930145424a03f6271927d62a0939327))
...
* **settings:** make dashboard values authoritative — NULL-inherit caps, telemetry decision wins over env ([#2186](https://github.com/Soju06/codex-lb/issues/2186)) ([8038e6d](https://github.com/Soju06/codex-lb/commit/8038e6d49b23563b9a806c62c4b3579e2351579b))
* **settings:** remove CODEX_LB_UPSTREAM_STREAM_TRANSPORT; dashboard owns upstream transport ([#2192](https://github.com/Soju06/codex-lb/issues/2192)) ([39a8b96](https://github.com/Soju06/codex-lb/commit/39a8b96ace6ddee75fc5ac97a8abb73938d1783a))
...
* **test:** follow the rustls and aws-lc-rs pins bumped in [#2453](https://github.com/Soju06/codex-lb/issues/2453) ([#2454](https://github.com/Soju06/codex-lb/issues/2454)) ([74dddf2](https://github.com/Soju06/codex-lb/commit/74dddf21cf7593e7b4a6d2a3df95032ce2622ab0))
...
* **ui:** constrain model source dialogs to viewport ([#2059](https://github.com/Soju06/codex-lb/issues/2059)) ([68dfc0e](https://github.com/Soju06/codex-lb/commit/68dfc0e014e9959f30f21fe4d27ca7f0d49ea042))
* **ui:** offer the reactivate action for deactivated accounts ([#2060](https://github.com/Soju06/codex-lb/issues/2060)) ([0f6a31c](https://github.com/Soju06/codex-lb/commit/0f6a31c56ac30804ca1c0fac27ca02c6f59bf2b0))
...
* **usage:** deactivate accounts only on explicit terminal signals, not bare 404/402 ([#2055](https://github.com/Soju06/codex-lb/issues/2055)) ([caad3d4](https://github.com/Soju06/codex-lb/commit/caad3d4088de0e98eef3805d90b40aa57e039dba))
* **utils:** consume a shared future's exception when no waiter is left ([#2427](https://github.com/Soju06/codex-lb/issues/2427)) ([f94dd50](https://github.com/Soju06/codex-lb/commit/f94dd509cbdc3a17fd5d1f55495d915db5258ab3))
* **warmup:** warm unused Free quota once ([#2205](https://github.com/Soju06/codex-lb/issues/2205)) ([a7785a8](https://github.com/Soju06/codex-lb/commit/a7785a80b55ab53fcae2a968eb74d79885d0f981))


### Performance Improvements

* **bridge:** resolve the prewarm snapshot only for eligible payloads ([#2340](https://github.com/Soju06/codex-lb/issues/2340)) ([c52941a](https://github.com/Soju06/codex-lb/commit/c52941a4ca66a62a85b1a68e0905296f0546a54d))
...
* **dashboard:** bound the raw tail of the conversation presence union to constant windows ([#2235](https://github.com/Soju06/codex-lb/issues/2235)) ([a408b57](https://github.com/Soju06/codex-lb/commit/a408b57a6e879a4a2b7ddb66cfbe3aca3915ab5a))
* **dashboard:** memoize weekly demand delta aggregates with a short TTL ([#2236](https://github.com/Soju06/codex-lb/issues/2236)) ([913c6eb](https://github.com/Soju06/codex-lb/commit/913c6eb5a3b7d7c9e65ffdc34badd62250e0f5c6))
* **egress:** batch ready SSE output writes ([c476104](https://github.com/Soju06/codex-lb/commit/c4761043badb9edcbe4a8d9324ed0e66033b818c))
...
* **proxy-responses:** parse each bridge SSE event once and relay unchanged upstream JSON text without re-dump ([55db6d7](https://github.com/Soju06/codex-lb/commit/55db6d77cb9e58b4f14ebcfd78db5a50e54674a9))
* **proxy-responses:** reuse the reader wakeup task and use fast_acquire locks in the HTTP-bridge relay loop ([2cf2efe](https://github.com/Soju06/codex-lb/commit/2cf2efe768fc20370cefbabf7918d0aa578620e1))
...
* **proxy:** clone selection-cache Account/UsageHistory rows via new_instance + instance_dict instead of the ORM constructor ([4d6fada](https://github.com/Soju06/codex-lb/commit/4d6fada977f5e894d54d2d8943083d4e04a9fc20))
...
* **proxy:** stop deep-validating and re-dumping passthrough JSON fields (input/tools/messages) in request models ([972a734](https://github.com/Soju06/codex-lb/commit/972a7341fa1fb19653ec21444e877324f357d8a2))
* **quota-planner:** reduce demand history per slot inside the database ([#2138](https://github.com/Soju06/codex-lb/issues/2138)) ([3d4d11a](https://github.com/Soju06/codex-lb/commit/3d4d11a6d17cd3b262c592620fb83eecbb8eceda))
* **reports:** serve historical reports from permanent aggregates ([#2227](https://github.com/Soju06/codex-lb/issues/2227)) ([3987abf](https://github.com/Soju06/codex-lb/commit/3987abfdf4a9cf372dde2f6694df2e4469bee602))
* **request-logs:** add live-row partial indexes for facet option queries ([#2246](https://github.com/Soju06/codex-lb/issues/2246)) ([44c635b](https://github.com/Soju06/codex-lb/commit/44c635b900b4e073069ef59391132e3081074adf))
* **request-logs:** speed up SQLite filter options ([#2253](https://github.com/Soju06/codex-lb/issues/2253)) ([8e6e260](https://github.com/Soju06/codex-lb/commit/8e6e260ae0c3ab6ebcdbbb2d9dd7528ea4156a7a))


### Reverts

* **bridge:** restore the recovery-dispatch claim and its fence ([#2383](https://github.com/Soju06/codex-lb/issues/2383)) ([a096b60](https://github.com/Soju06/codex-lb/commit/a096b6092f7d43b5c59d823a4aefc1b08b6b7f6b))
* **overflow:** remove the subscription-exhaustion model-source fallback ([#2416](https://github.com/Soju06/codex-lb/issues/2416)) ([982125a](https://github.com/Soju06/codex-lb/commit/982125a334fea281af10a562b9b28c4db1afbff7))


### Documentation

* add codex-lb-status community companion ([#2116](https://github.com/Soju06/codex-lb/issues/2116)) ([b383d09](https://github.com/Soju06/codex-lb/commit/b383d09dd0bf157cbb15288a4155a253034cd6bb))
...
* **companions:** add Codex LB for Omarchy ([#2172](https://github.com/Soju06/codex-lb/issues/2172)) ([7887ef1](https://github.com/Soju06/codex-lb/commit/7887ef1cdffe8e7ef015452cf85f99ce5df5bdcf))
* **companions:** add Codex-LB Rates ([#2346](https://github.com/Soju06/codex-lb/issues/2346)) ([8eeaad9](https://github.com/Soju06/codex-lb/commit/8eeaad9f695811dee55373de68fba1975c3cd2d5))
* **helm:** document the pre-1.13 StatefulSet migration shim and its deprecation ([#2230](https://github.com/Soju06/codex-lb/issues/2230)) ([a8bd1f6](https://github.com/Soju06/codex-lb/commit/a8bd1f6dfe2727890bf8a36e61dd41b411ccf0bb))
...
* **openspec:** archive 14 completed and fully-synced changes ([#2181](https://github.com/Soju06/codex-lb/issues/2181)) ([85fcb8d](https://github.com/Soju06/codex-lb/commit/85fcb8decb5f9881dc34cd0ecced6a413d2250fb))
* **openspec:** archive 157 landed changes (Tier A, batches A01–A09) ([#2216](https://github.com/Soju06/codex-lb/issues/2216)) ([8a6ecc9](https://github.com/Soju06/codex-lb/commit/8a6ecc933f549d4e6753d14eaf7cb67ca6f33252))
* **openspec:** archive the dashboard-managed settings changes from C2 ([#2229](https://github.com/Soju06/codex-lb/issues/2229)) ([88264ff](https://github.com/Soju06/codex-lb/commit/88264ff8413ef1770cfec0aec516018fb23479bd))
* **openspec:** archive the landed campaign changes and repair one stale delta ([#2359](https://github.com/Soju06/codex-lb/issues/2359)) ([789a2dd](https://github.com/Soju06/codex-lb/commit/789a2dd3d658b9a9382d88338dd71684e6bd5c59))
* **openspec:** archive the round-3 settings changes ([#2293](https://github.com/Soju06/codex-lb/issues/2293)) ([ef1af87](https://github.com/Soju06/codex-lb/commit/ef1af872d9d79eb2dad12e0a58b332c059c4888d))
* **openspec:** codify configuration tiers — dashboard is primary, env is bootstrap/topology only ([#2182](https://github.com/Soju06/codex-lb/issues/2182)) ([66b26fa](https://github.com/Soju06/codex-lb/commit/66b26fa8f2f82c196cff645ec01cfadafa95a2b4))
* **openspec:** propose relocating anchored turns across accounts ([#2374](https://github.com/Soju06/codex-lb/issues/2374)) ([3d23d53](https://github.com/Soju06/codex-lb/commit/3d23d53f89dbbaa2353040a30451cf90ca48ee92))
* **openspec:** propose walking the account pool before surfacing a 429 ([#2373](https://github.com/Soju06/codex-lb/issues/2373)) ([5918362](https://github.com/Soju06/codex-lb/commit/5918362e8a6898817e97ef1fa408d0b74da02c81))
* **openspec:** replace archive-generated Purpose stubs with real purpose statements ([#2228](https://github.com/Soju06/codex-lb/issues/2228)) ([a97ffc3](https://github.com/Soju06/codex-lb/commit/a97ffc3217f1cbc1c9f1a3ed48ab7813bb034439))
* **openspec:** sync and archive the remaining landed changes (Tier B + holds) ([#2219](https://github.com/Soju06/codex-lb/issues/2219)) ([3e78b0b](https://github.com/Soju06/codex-lb/commit/3e78b0b646eca38e277a89d706f7dc9f1e94a5aa))
* resolve stale archive-conditionals, broken links and template placeholders ([#2180](https://github.com/Soju06/codex-lb/issues/2180)) ([8356d35](https://github.com/Soju06/codex-lb/commit/8356d35bd1316f7be860f027250ec1290ab3a784))
* **zh-CN:** fix wrong provider name and retired model slug in client config ([#2178](https://github.com/Soju06/codex-lb/issues/2178)) ([a2678f4](https://github.com/Soju06/codex-lb/commit/a2678f43d3bfb2b55b137beba7b6b6a6f39a3ed1))
* **zh-CN:** mirror the English README structure and point to the docs site ([#2210](https://github.com/Soju06/codex-lb/issues/2210)) ([d7e8c0e](https://github.com/Soju06/codex-lb/commit/d7e8c0e21c13e0ec04a563855972733476ca84b0))


### Code Refactoring

* **config:** remove dead and deprecated CODEX_LB_* env fields, rotate removed-settings warning list ([#2190](https://github.com/Soju06/codex-lb/issues/2190)) ([fe2915d](https://github.com/Soju06/codex-lb/commit/fe2915dde482b62e5859edf541b35a1facddf850))
...
* **config:** timeout-invariant linter — validate deadline/TTL inequalities at startup and in CI ([#1622](https://github.com/Soju06/codex-lb/issues/1622)) ([d148dd9](https://github.com/Soju06/codex-lb/commit/d148dd9a42dca3088e8063aca8a21682f9bf7fb6))
...
* **model-sources:** embeddings source capability ([#1776](https://github.com/Soju06/codex-lb/issues/1776)) ([4d0f0ff](https://github.com/Soju06/codex-lb/commit/4d0f0ffc64df11a6800397497512abeb5478bce2))
...
* **telemetry:** report consent state and send a decision-time opt-out signal ([#1835](https://github.com/Soju06/codex-lb/issues/1835)) ([1541ee8](https://github.com/Soju06/codex-lb/commit/1541ee83105edd9a06062f6bcc617f9dab595a66))
...
* **ui:** surface reasoning token usage ([#1801](https://github.com/Soju06/codex-lb/issues/1801)) ([8e7589e](https://github.com/Soju06/codex-lb/commit/8e7589e4286869b9030eb1b19726297c63852ed3))
...
* **db:** repair retired identity/warmup migration stamp ([#1847](https://github.com/Soju06/codex-lb/issues/1847)) ([b6c217f](https://github.com/Soju06/codex-lb/commit/b6c217fada24c8a7b7e2c77af6bce3e2d7a2d3e2))
...
* **helm:** bind TTFT dashboard SQL datasource ([#1827](https://github.com/Soju06/codex-lb/issues/1827)) ([8abd507](https://github.com/Soju06/codex-lb/commit/8abd50778dd15131fac01f6a40d8e07a1bcebf54))
* **http-bridge:** classify recovery error frames and poison same-anchor eventless failures ([#1841](https://github.com/Soju06/codex-lb/issues/1841)) ([01f089c](https://github.com/Soju06/codex-lb/commit/01f089c359dadc2cc75b0719addc646e116624a5))
...
* **http-bridge:** keep missing-created watchdog armed after prelude and handle stale API-key activity ([#1580](https://github.com/Soju06/codex-lb/issues/1580)) ([0eb0ee7](https://github.com/Soju06/codex-lb/commit/0eb0ee7939309dfd264f56a88d1bbcb519fde5c6))
...
* **models:** apply context-window overrides to /v1 input context fields ([#1808](https://github.com/Soju06/codex-lb/issues/1808)) ([c750dcf](https://github.com/Soju06/codex-lb/commit/c750dcfe64961c7d538c75367e9ee509fe8c9052))
...
* **models:** raise GPT-5.6 bootstrap max_context_window to 872k ([#1813](https://github.com/Soju06/codex-lb/issues/1813)) ([1add104](https://github.com/Soju06/codex-lb/commit/1add1041b61e7b20ea104a91dd6331f03db904c7))
...
* **proxy:** absorb replay-safe compaction recovery ([#1849](https://github.com/Soju06/codex-lb/issues/1849)) ([c597226](https://github.com/Soju06/codex-lb/commit/c597226cf139ec1e80117b72f02b7a18bef3645f))
...
* **proxy:** bind account-bound retries to dispatch owner ([#1829](https://github.com/Soju06/codex-lb/issues/1829)) ([3381938](https://github.com/Soju06/codex-lb/commit/3381938aa278d7f3cd371bdd76c7914856586bf8))
* **proxy:** classify parameterless previous response errors ([#1818](https://github.com/Soju06/codex-lb/issues/1818)) ([eeab46a](https://github.com/Soju06/codex-lb/commit/eeab46a5edf5be16ff2915edc21a7f6a9a424717))
...
* **proxy:** demote quarantined bridge reattach keys ([#1730](https://github.com/Soju06/codex-lb/issues/1730)) ([5e1f568](https://github.com/Soju06/codex-lb/commit/5e1f568f3a2772b4d1162a5e325d056cae7daa39))
...
* **proxy:** drop malformed compact item ids ([#1815](https://github.com/Soju06/codex-lb/issues/1815)) ([812265d](https://github.com/Soju06/codex-lb/commit/812265d11c0faa470da1db1b689442afa2b93869))
...
* **proxy:** O(1) shared-future admission waits + event-loop lag watchdog ([#1842](https://github.com/Soju06/codex-lb/issues/1842)) ([ed2c94d](https://github.com/Soju06/codex-lb/commit/ed2c94d4b8ece64455233e5293d44ec0f263e6bc))
...
* **proxy:** preserve compact terminal error type ([#1824](https://github.com/Soju06/codex-lb/issues/1824)) ([78d63e5](https://github.com/Soju06/codex-lb/commit/78d63e5a840c1cc6a34a03cb002eac9b3e041f7e))
* **proxy:** reject truncated chat completion streams ([#1833](https://github.com/Soju06/codex-lb/issues/1833)) ([6ba083d](https://github.com/Soju06/codex-lb/commit/6ba083d7df4f82c2d2e6aa08e9a1e1fb47b59faa))
...
* **proxy:** report suppressed duplicate tool-call terminals ([#1706](https://github.com/Soju06/codex-lb/issues/1706)) ([25d6374](https://github.com/Soju06/codex-lb/commit/25d6374a8a671900a6bf4dc89f248e7834efad76))
* **proxy:** retain image reservation recovery ownership ([#1822](https://github.com/Soju06/codex-lb/issues/1822)) ([bd67c64](https://github.com/Soju06/codex-lb/commit/bd67c640012692786f6beddd3d61c67cea759c47))
...
* **proxy:** wait on usage-refresh singleflight without asyncio.shield ([#1897](https://github.com/Soju06/codex-lb/issues/1897)) ([798203f](https://github.com/Soju06/codex-lb/commit/798203ff9d9d8f30a9b53e181d34fc9935ba5444)), closes [#1896](https://github.com/Soju06/codex-lb/issues/1896)
...
* **reports:** format full Cost values with grouping separators ([#1814](https://github.com/Soju06/codex-lb/issues/1814)) ([028a75c](https://github.com/Soju06/codex-lb/commit/028a75c33701494834c054718fb58e31d72c4d99))
...
* **warmup:** warm paid-to-free transitions ([#1825](https://github.com/Soju06/codex-lb/issues/1825)) ([68892e7](https://github.com/Soju06/codex-lb/commit/68892e7afff21cff8910e2ee5456317eff6e231b))
...
* **auth:** enable Auth Guardian by default and cover paused accounts ([#1662](https://github.com/Soju06/codex-lb/issues/1662)) ([ebb0525](https://github.com/Soju06/codex-lb/commit/ebb052505c58c7ce7d7f72bb6ca1831974568874))
* **dashboard:** Add conversation list on dashboard and details dialog ([#1477](https://github.com/Soju06/codex-lb/issues/1477)) ([c539a20](https://github.com/Soju06/codex-lb/commit/c539a200c301e5cdf2cf524dea336e1c40094bbd))
* **helm:** allow Grafana dashboard title overrides ([#1482](https://github.com/Soju06/codex-lb/issues/1482)) ([266fbe2](https://github.com/Soju06/codex-lb/commit/266fbe2adf118651f6723d8bdca814ff2aabc73b))
...
* **proxy:** add durable capability lineage for reconnect ([#1562](https://github.com/Soju06/codex-lb/issues/1562)) ([151c42c](https://github.com/Soju06/codex-lb/commit/151c42c64810f773080ed58710791b216a8d9b8a))
* **proxy:** congestion-aware per-API-key fair-share stream admission ([#1536](https://github.com/Soju06/codex-lb/issues/1536)) ([0518b93](https://github.com/Soju06/codex-lb/commit/0518b93ab74b8c3d2967125ee24f9e39811a2304))
...
* **ui:** add iso8601 date display format to settings ([#1671](https://github.com/Soju06/codex-lb/issues/1671)) ([b03d39f](https://github.com/Soju06/codex-lb/commit/b03d39f3d786cf1a2da29199340fa4cfaff0d8e3))
* **ui:** complete zh-CN dashboard translations ([#1436](https://github.com/Soju06/codex-lb/issues/1436)) ([79a42ce](https://github.com/Soju06/codex-lb/commit/79a42ce6d0f408b8d80b6d0bb280a6393bcba5f2))
* **ui:** separate service and usage health status ([#1495](https://github.com/Soju06/codex-lb/issues/1495)) ([6b1f476](https://github.com/Soju06/codex-lb/commit/6b1f4769501d943c031a5246ada4b6eaea91dfde))
* **ui:** warn when request log retention is disabled ([#1496](https://github.com/Soju06/codex-lb/issues/1496)) ([d2dc915](https://github.com/Soju06/codex-lb/commit/d2dc9151890fdc77368a568badd6c331b5496069))


### Bug Fixes

* **api-keys:** make the shutdown flush of last_used_at coalescing lossless ([#1667](https://github.com/Soju06/codex-lb/issues/1667)) ([0fcb6a7](https://github.com/Soju06/codex-lb/commit/0fcb6a7aceeca058e02000a14f92970f9d3a91d5))
* **api-keys:** restore last-used compatibility touch ([#1656](https://github.com/Soju06/codex-lb/issues/1656)) ([3fffc0c](https://github.com/Soju06/codex-lb/commit/3fffc0c1cc4dbc0d4606e5c0bc7d36e3585eaf03))
* **auth:** keep guardian candidates session-safe ([#1669](https://github.com/Soju06/codex-lb/issues/1669)) ([ff2920c](https://github.com/Soju06/codex-lb/commit/ff2920cab1eba62da7c540a1b72b71961553d57d)), closes [#1668](https://github.com/Soju06/codex-lb/issues/1668)
* **auth:** restrict guest access to sensitive request data ([#1497](https://github.com/Soju06/codex-lb/issues/1497)) ([73aa50e](https://github.com/Soju06/codex-lb/commit/73aa50eafe446e542897b6007a5778fdacb9a2ae))
* **cache:** recover invalidation after failed prime ([#1544](https://github.com/Soju06/codex-lb/issues/1544)) ([ba5a283](https://github.com/Soju06/codex-lb/commit/ba5a283ecbeccee626293422287e988eaffcc584))
* **ci:** back off Codex review triggers on usage limits (takeover of [#1560](https://github.com/Soju06/codex-lb/issues/1560)) ([#1631](https://github.com/Soju06/codex-lb/issues/1631)) ([c33bc41](https://github.com/Soju06/codex-lb/commit/c33bc41e9bdc7f1f281d7ea3b2d3fa6d3b522c9a))
* **compact:** elide observed inline images at wire cap ([#1457](https://github.com/Soju06/codex-lb/issues/1457)) ([8d154ec](https://github.com/Soju06/codex-lb/commit/8d154ecb559243b2aedc9fd8c2bd09b400e3c518))
* **cost:** openai updates the terra and luna's cost ([#1553](https://github.com/Soju06/codex-lb/issues/1553)) ([c1d1892](https://github.com/Soju06/codex-lb/commit/c1d18929a689d57f9c908f9615041e58de93ad89))
* **db:** correct PostgreSQL pool budget ([#1519](https://github.com/Soju06/codex-lb/issues/1519)) ([68a2bc1](https://github.com/Soju06/codex-lb/commit/68a2bc14fe3e2932208d1e8996931da427ce7ec4))
* **db:** handle percent-encoded SQLite URLs on Windows (takeover of [#1295](https://github.com/Soju06/codex-lb/issues/1295)) ([#1597](https://github.com/Soju06/codex-lb/issues/1597)) ([e5dbd9a](https://github.com/Soju06/codex-lb/commit/e5dbd9ac824553c5ed05f5e4fad0e8a3f67ff9b8))
* **db:** keep api-key reservation accounting at full durability ([#1665](https://github.com/Soju06/codex-lb/issues/1665)) ([5b81f2d](https://github.com/Soju06/codex-lb/commit/5b81f2d75dbbdf7c1656373a6ba14a5b2bde6a07))
* **db:** release SQLite handles before file mutations ([#1526](https://github.com/Soju06/codex-lb/issues/1526)) ([58c5eaf](https://github.com/Soju06/codex-lb/commit/58c5eaff2d8843745c798b8e3a821f9c3cc62af1))
* **fleet:** expose quota snapshot refresh timestamp ([#1640](https://github.com/Soju06/codex-lb/issues/1640)) ([006eff9](https://github.com/Soju06/codex-lb/commit/006eff937da6e537f8acc70023f195eb929c0fb7))
* **helm:** calculate aggregate 5xx error rate ([#1522](https://github.com/Soju06/codex-lb/issues/1522)) ([b883d69](https://github.com/Soju06/codex-lb/commit/b883d69dc6e2123a08ec84b9ea992adf30d2b28e))
* **http-bridge:** stabilize silent and clean-close recovery ([#1394](https://github.com/Soju06/codex-lb/issues/1394)) ([a66f793](https://github.com/Soju06/codex-lb/commit/a66f79370ff59a7931dced6b70213f5bd2b531ca))
* **http-bridge:** wait before retrying model capacity ([#1395](https://github.com/Soju06/codex-lb/issues/1395)) ([448b239](https://github.com/Soju06/codex-lb/commit/448b239c4db8170fc8c559fbe27f57f2ccfb9874))
* **proxy-responses:** tolerate structured content type values ([#1566](https://github.com/Soju06/codex-lb/issues/1566)) ([8600a60](https://github.com/Soju06/codex-lb/commit/8600a60ea661bc3c8c7dfae11e3678a3a72a266c))
* **proxy:** attribute bridge failure fan-out request logs to each request's API key ([#1540](https://github.com/Soju06/codex-lb/issues/1540)) ([3fe0d6f](https://github.com/Soju06/codex-lb/commit/3fe0d6f286019a0505783d803db9a1d8cdf6b307))
* **proxy:** attribute websocket request kind per turn ([#1602](https://github.com/Soju06/codex-lb/issues/1602)) ([e3bc442](https://github.com/Soju06/codex-lb/commit/e3bc4420ada76edd515619a5976deb6da14344e4))
* **proxy:** bound upstream streams that never send response headers ([#1611](https://github.com/Soju06/codex-lb/issues/1611)) ([af5051f](https://github.com/Soju06/codex-lb/commit/af5051f871fef7f87d8da499f29e9a61a36d36d4))
* **proxy:** classify tool-search missing-tool-output rejections ([#1531](https://github.com/Soju06/codex-lb/issues/1531)) ([7739648](https://github.com/Soju06/codex-lb/commit/773964875b3f892aa1790db665698171c7d1774d)), closes [#1168](https://github.com/Soju06/codex-lb/issues/1168)
* **proxy:** clear durable bridge anchor after stuck eventless timeout ([#1563](https://github.com/Soju06/codex-lb/issues/1563)) ([4c04e53](https://github.com/Soju06/codex-lb/commit/4c04e538b86dfbe4fdd32f3360200d92e93529e3))
* **proxy:** complete Codex compaction SSE lifecycle ([#1634](https://github.com/Soju06/codex-lb/issues/1634)) ([7f91b91](https://github.com/Soju06/codex-lb/commit/7f91b91f0a6c14cd6a8ee903f40da3e5da5c593d))
* **proxy:** detect stalled upstream websockets ([#1579](https://github.com/Soju06/codex-lb/issues/1579)) ([a0a977a](https://github.com/Soju06/codex-lb/commit/a0a977a6f53b42aecec83c29395bb543f194750e))
* **proxy:** drain active WebSocket turns on shutdown ([#1520](https://github.com/Soju06/codex-lb/issues/1520)) ([66b9196](https://github.com/Soju06/codex-lb/commit/66b9196d188ef85843b24fa1a26067057c075c83))
...
* **proxy:** fail over dead account proxy routes before upstream dispatch ([#1542](https://github.com/Soju06/codex-lb/issues/1542)) ([e9a9e8a](https://github.com/Soju06/codex-lb/commit/e9a9e8a8bc1d4e3b40a6064950c8d923a7fa79c1))
* **proxy:** fail over stuck HTTP bridge owner requests to a fresh account ([#1401](https://github.com/Soju06/codex-lb/issues/1401)) ([f2f8f91](https://github.com/Soju06/codex-lb/commit/f2f8f916ab882a120b3abf406157f44c12b58cc5))
* **proxy:** keep upstream request-shape rejections account neutral ([#1532](https://github.com/Soju06/codex-lb/issues/1532)) ([24d12f2](https://github.com/Soju06/codex-lb/commit/24d12f28ed5d95a552fcca15115d654e1ab0c411))
* **proxy:** never inject a cross-account previous_response_id anchor (takeover of [#1274](https://github.com/Soju06/codex-lb/issues/1274)) ([#1638](https://github.com/Soju06/codex-lb/issues/1638)) ([6839705](https://github.com/Soju06/codex-lb/commit/68397054f58bf20e61e14263ee881c1b2532c7b9))
* **proxy:** normalize timestamptz lease expiry in durable lease liveness check ([#1673](https://github.com/Soju06/codex-lb/issues/1673)) ([7913ff9](https://github.com/Soju06/codex-lb/commit/7913ff920d2c7eed85394581a427196df8d47865))
* **proxy:** preserve developer-interleaved fresh resends ([#1537](https://github.com/Soju06/codex-lb/issues/1537)) ([201281b](https://github.com/Soju06/codex-lb/commit/201281b55a2b6fb6473214d69650933d27b58faa))
...
* **proxy:** preserve terminal delivery across detach ([#1527](https://github.com/Soju06/codex-lb/issues/1527)) ([4694a5c](https://github.com/Soju06/codex-lb/commit/4694a5cd43d8c063996c680a38f8c23eb4e6a4f2))
* **proxy:** preserve websocket connect errors ([#1517](https://github.com/Soju06/codex-lb/issues/1517)) ([2ba5f9a](https://github.com/Soju06/codex-lb/commit/2ba5f9a65d00dcce8ff0c6505d0484e6574b8c24))
* **proxy:** purge stale hard codex_session mappings pinned to a durably unavailable owner ([#1417](https://github.com/Soju06/codex-lb/issues/1417)) ([b1d27bc](https://github.com/Soju06/codex-lb/commit/b1d27bc62808427b67ffea547a6a89a0d034f26e))
* **proxy:** quarantine silent HTTP bridge sessions (takeover of [#1405](https://github.com/Soju06/codex-lb/issues/1405)) ([#1630](https://github.com/Soju06/codex-lb/issues/1630)) ([3aabe99](https://github.com/Soju06/codex-lb/commit/3aabe99811d67bbd59f1b8ce6a788ad798c597c3))
* **proxy:** reconcile durable full resend owner ([#1599](https://github.com/Soju06/codex-lb/issues/1599)) ([e959326](https://github.com/Soju06/codex-lb/commit/e9593266092f44164920787ec9d19bf5c9d67f10))
* **proxy:** recover dead durable bridge anchors fast ([#1625](https://github.com/Soju06/codex-lb/issues/1625)) ([85f1ee4](https://github.com/Soju06/codex-lb/commit/85f1ee4b40a56beb6ddb5d96a570073169bfa8f4))
* **proxy:** release idle bridge sessions' account stream leases ([#1476](https://github.com/Soju06/codex-lb/issues/1476)) ([9349040](https://github.com/Soju06/codex-lb/commit/934904045837a1c23fc260b2fb38927040f7e6d3))
* **proxy:** report eligible pool usage exhaustion as 429 ([#1541](https://github.com/Soju06/codex-lb/issues/1541)) ([897ae15](https://github.com/Soju06/codex-lb/commit/897ae156cfd3254b2cd85e148afcb6275cd4bdf1))
* **proxy:** retry detached API key release ([#1545](https://github.com/Soju06/codex-lb/issues/1545)) ([35e09f6](https://github.com/Soju06/codex-lb/commit/35e09f68ad6700c5d7e44636aceca24bd948cf72))
...
* **proxy:** sequence websocket health after settlement ([#1558](https://github.com/Soju06/codex-lb/issues/1558)) ([d77011b](https://github.com/Soju06/codex-lb/commit/d77011b1882c3150514eb9a8c0f5508775cb2222))
* **proxy:** settle reservations when terminal bookkeeping aborts ([#1600](https://github.com/Soju06/codex-lb/issues/1600)) ([ce7b586](https://github.com/Soju06/codex-lb/commit/ce7b586900148027c585c7dbacdda42aeafacb0e)), closes [#1594](https://github.com/Soju06/codex-lb/issues/1594)
* **proxy:** spill unanchored forks on account caps ([#1499](https://github.com/Soju06/codex-lb/issues/1499)) ([0284251](https://github.com/Soju06/codex-lb/commit/0284251be49f29e473c4a09c3f8de5415b3b16f8))
* **proxy:** strip replayed tool call namespaces ([#1578](https://github.com/Soju06/codex-lb/issues/1578)) ([7c456df](https://github.com/Soju06/codex-lb/commit/7c456df732cd3daad06e39d086ee988b136c46b5))
* **proxy:** surface forwarded compact settlement failures ([#1561](https://github.com/Soju06/codex-lb/issues/1561)) ([2176b14](https://github.com/Soju06/codex-lb/commit/2176b1499e4d7e4243b47e38e7d06c2d0dec7de3))
* **quota:** release reservations on header failure ([#1559](https://github.com/Soju06/codex-lb/issues/1559)) ([783665b](https://github.com/Soju06/codex-lb/commit/783665b958f62cb8b39c5c74dd977774bde85189))
* **quota:** warm free monthly resets ([#1504](https://github.com/Soju06/codex-lb/issues/1504)) ([dc9f9d7](https://github.com/Soju06/codex-lb/commit/dc9f9d71e407277dafbc9f2a6eab8bc2fb402261))
* **reports:** use local days for daily averages ([#1525](https://github.com/Soju06/codex-lb/issues/1525)) ([eefce19](https://github.com/Soju06/codex-lb/commit/eefce19d63982f9b5138fb8893a6ba00a3a05a68))
* **usage:** confirm workspace-less paid to free plan downgrades ([#1491](https://github.com/Soju06/codex-lb/issues/1491)) ([927a3c0](https://github.com/Soju06/codex-lb/commit/927a3c058d261865f6f34d8341a80d1adb1c6f90))
* **usage:** keep the covering read path effective on append-heavy usage_history ([#1666](https://github.com/Soju06/codex-lb/issues/1666)) ([967114d](https://github.com/Soju06/codex-lb/commit/967114da2aade00e17a725cc2a3db9e5875cd542))


### Performance Improvements

* **api-keys:** coalesce last_used_at writes behind a periodic flush ([#1627](https://github.com/Soju06/codex-lb/issues/1627)) ([8466703](https://github.com/Soju06/codex-lb/commit/8466703b388d96d2b464c84b374bab33976ad079))
* **dashboard:** bound projection history fetch per account ([#1613](https://github.com/Soju06/codex-lb/issues/1613)) ([09e1b5c](https://github.com/Soju06/codex-lb/commit/09e1b5cd54329ade11a9a313314d3f90dc8079be))
* **dashboard:** serve conversation metrics from an hourly presence rollup ([#1616](https://github.com/Soju06/codex-lb/issues/1616)) ([80df35a](https://github.com/Soju06/codex-lb/commit/80df35adebc07bd7e299cca73d64f44125329aa7))
* **db:** relax commit durability for telemetry writes on PostgreSQL ([#1628](https://github.com/Soju06/codex-lb/issues/1628)) ([7c799cf](https://github.com/Soju06/codex-lb/commit/7c799cff6bbd77a49205f91b4461dd9bb27b67cf))
* **request-logs:** serve listing totals from the demand rollup plus raw tail ([#1615](https://github.com/Soju06/codex-lb/issues/1615)) ([778c533](https://github.com/Soju06/codex-lb/commit/778c533fea403240ea30e2a03dbbe305f924e991))
* **usage:** cover the projections bulk history fetch with an index-only path ([#1629](https://github.com/Soju06/codex-lb/issues/1629)) ([410bfae](https://github.com/Soju06/codex-lb/commit/410bfaea8022ef2dd32a0305d700e2fbe64eb924))
* **usage:** probe additional-usage latest reads instead of DISTINCT ON scans ([#1614](https://github.com/Soju06/codex-lb/issues/1614)) ([54881d2](https://github.com/Soju06/codex-lb/commit/54881d2cfd783674bf0fc5eb1b6e35149f359920))


### Documentation

* add README hero banner image ([#1516](https://github.com/Soju06/codex-lb/issues/1516)) ([e9273d2](https://github.com/Soju06/codex-lb/commit/e9273d209798a787eb58c9f24f8d0d643e381259))
...
* **contributors:** add joschi655 (missed by admin merge of [#1611](https://github.com/Soju06/codex-lb/issues/1611)) ([#1617](https://github.com/Soju06/codex-lb/issues/1617)) ([d276a4d](https://github.com/Soju06/codex-lb/commit/d276a4db2550592f245ea636a627d7623c11ae2b))
* **contributors:** add lkraider, ret2basic, and yeongjun-cigro ([#1596](https://github.com/Soju06/codex-lb/issues/1596)) ([a1599da](https://github.com/Soju06/codex-lb/commit/a1599dab482c01d85cbb70a74c27026888cc825c))
* **contributors:** restore chronological contributor order ([#1518](https://github.com/Soju06/codex-lb/issues/1518)) ([b91d9bb](https://github.com/Soju06/codex-lb/commit/b91d9bb8768edbfda6d232a4bc2fa013053519fc))
* **openspec:** canonical-code signal for Codex WebSocket stale-anchor recovery ([#1529](https://github.com/Soju06/codex-lb/issues/1529)) ([#1550](https://github.com/Soju06/codex-lb/issues/1550)) ([0095b6e](https://github.com/Soju06/codex-lb/commit/0095b6ea68618328b7d93008854e6e1d39114ad6))
* **openspec:** fix strict requirement line formatting ([#1637](https://github.com/Soju06/codex-lb/issues/1637)) ([a66da90](https://github.com/Soju06/codex-lb/commit/a66da90f843d1851988326b5fe1c24ba76f4706f))
